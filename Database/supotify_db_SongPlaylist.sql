...
CREATE TABLE `SongPlaylist` (
  ...
  CONSTRAINT `songplaylist_ibfk_1` FOREIGN KEY (`song_id`) REFERENCES `Song` (`song_id`),
  CONSTRAINT `songplaylist_ibfk_2` FOREIGN KEY (`playlist_id`) REFERENCES `Playlist` (`playlist_id`)
